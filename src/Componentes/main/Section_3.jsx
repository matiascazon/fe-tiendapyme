                                    ...
                                    <div className="product__items--content text-center">
                                        <div className="product__items--color">
                                            <ul className="product__items--color__wrapper d-flex justify-content-center">
                                                ...
                                                <li className="product__items--color__list"><a className="product__items--color__link four" href="javascript:void(0)"><span className="visually-hidden">Color 3</span></a></li>
                                            </ul>
                                        </div>
