                        ...
                        <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n30">
                                ...
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            ...
                                            <img class="product__items--img product__secondary--img" src="../../src/assets/img/product/product1.webp" alt="product-img"/>
                                        </a>
                                        <ul class="product__items--action d-flex justify-content-center">
                                            <li class="product__items--action__list">
                                                <a class="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img" src="../../src/assets/img/product/product14.webp" alt="product-img"/>
                                            <img class="product__items--img product__secondary--img" src="../../src/assets/img/product/product2.webp" alt="product-img"/>
                                        </a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">New</span>
                            ...
                            <div class="col mb-30">
                                <div class="product__items ">
                                    <div class="product__items--thumbnail">
                                        <a class="product__items--link" href="product-details.html">
                                            <img class="product__items--img product__primary--img" src="../../src/assets/img/product/product6.webp" alt="product-img"/>
                                            <img class="product__items--img product__secondary--img" src="../../src/assets/img/product/product5.webp" alt="product-img"/>
                                        </a>
                                        <div class="product__badge">
                                            <span class="product__badge--items sale">New</span>
                                        </div>
