                            ...
                            <div className="row row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2 mb--n25">
                                    ...
                                    <div className="product__items">
                                        <div className="product__items--thumbnail">
                                            <a className="product__items--link" href="product-details.html">
                                                <img className="product__items--img product__primary--img" src="../../src/assets/img/product/product1.webp" alt="product-img"/>
                                                <img className="product__items--img product__secondary--img" src="../../src/assets/img/product/product2.webp" alt="product-img"/>
                                            </a>
                                        ...
                                        <div className="product__items--content style2 position__relative">
                                            ...
                                            <h3 className="product__items--content__title h4"><a href="product-details.html">Fashion Chair</a></h3>
                                            ...
                                            <a className="product__cart--btn__style2 primary__btn" href="cart.html">  Add to cart </a>
                                        </div>
                                    </div>
                                </div>
                                <div className="col mb-25">
                                    <div className="product__items">
                                        <div className="product__items--thumbnail">
                                            <a className="product__items--link" href="product-details.html">
                                                <img className="product__items--img product__primary--img" src="../../src/assets/img/product/product3.webp" alt="product-img"/>
                                                <img className="product__items--img product__secondary--img" src="../../src/assets/img/product/product4.webp" alt="product-img"/>
                                            </a>
                                            <ul className="product__items--action d-flex justify-content-center">
                                                <li className="product__items--action__list">
                                                    <a className="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                        ...
                                        <div className="product__items--content style2 position__relative">
                                            ...
                                            <h3 className="product__items--content__title h4"><a href="product-details.html">Globe Electric</a></h3>
                                            <div className="product__items--price style2">
                                ...
                                <div className="col mb-25">
                                    <div className="product__items">
                                        <div className="product__items--thumbnail">
                                            <a className="product__items--link" href="product-details.html">
                                                <img className="product__items--img product__primary--img" src="../../src/assets/img/product/product5.webp" alt="product-img"/>
                                                <img className="product__items--img product__secondary--img" src="../../src/assets/img/product/product6.webp" alt="product-img"/>
                                            </a>
                                            <div className="product__badge">
                                                <span className="product__badge--items sale">New</span>
                                            </div>
                                        ...
                                        <div className="product__items--content style2 position__relative">
                                            ...
                                            <h3 className="product__items--content__title h4"><a href="product-details.html">Swivel Chair</a></h3>
                                            <div className="product__items--price style2">
                                ...
                                <div className="col mb-25">
                                    <div className="product__items">
                                        <div className="product__items--thumbnail">
                                            <a className="product__items--link" href="product-details.html">
                                                <img className="product__items--img product__primary--img" src="../../src/assets/img/product/product7.webp" alt="product-img"/>
                                                <img className="product__items--img product__secondary--img" src="../../src/assets/img/product/product8.webp" alt="product-img"/>
                                            </a>
                                            <ul className="product__items--action d-flex justify-content-center">
                                                <li className="product__items--action__list">
                                                    <a className="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                        ...
                                        <div className="product__items--content style2 position__relative">
                                            ...
                                            <h3 className="product__items--content__title h4"><a href="product-details.html">Plastic Chair</a></h3>
                                            <div className="product__items--price style2">
                                ...
                                <div className="col mb-25">
                                    <div className="product__items">
                                        <div className="product__items--thumbnail">
                                            <a className="product__items--link" href="product-details.html">
                                                <img className="product__items--img product__primary--img" src="../../src/assets/img/product/product9.webp" alt="product-img"/>
                                                <img className="product__items--img product__secondary--img" src="../../src/assets/img/product/product10.webp" alt="product-img"/>
                                            </a>
                                            <div className="product__badge">
                                                <span className="product__badge--items sale">New</span>
                                            </div>
                                        ...
                                        <div className="product__items--content style2 position__relative">
                                            ...
                                            <h3 className="product__items--content__title h4"><a href="product-details.html">Folding Tables</a></h3>
                                            <div className="product__items--price style2">
                                ...
                                <div className="col mb-25">
                                    <div className="product__items">
                                        <div className="product__items--thumbnail">
                                            <a className="product__items--link" href="product-details.html">
                                                <img className="product__items--img product__primary--img" src="../../src/assets/img/product/product11.webp" alt="product-img"/>
                                                <img className="product__items--img product__secondary--img" src="../../src/assets/img/product/product12.webp" alt="product-img"/>
                                            </a>
                                            <ul className="product__items--action d-flex justify-content-center">
                                                <li className="product__items--action__list">
                                                    <a className="product__items--action__btn" data-open="modal1" href="javascript:void(0)">
                                        ...
                                        <div className="product__items--content style2 position__relative">
                                            ...
                                            <h3 className="product__items--content__title h4"><a href="product-details.html">Tables Chairs</a></h3>
                                            <div className="product__items--price style2">
                                ...
                                <div className="col d-xl-none d-xxl-block mb-25">
                                    <div className="product__items">
                                        <div className="product__items--thumbnail">
                                            <a className="product__items--link" href="product-details.html">
                                                <img className="product__items--img product__primary--img" src="../../src/assets/img/product/product13.webp" alt="product-img"/>
                                                <img className="product__items--img product__secondary--img" src="../../src/assets/img/product/product14.webp" alt="product-img"/>
                                            </a>
                                            <div className="product__badge">
                                                <span className="product__badge--items sale">New</span>
                                            </div>
                                        ...
                                        <div className="product__items--content style2 position__relative">
                                            ...
                                            <h3 className="product__items--content__title h4"><a href="product-details.html">Fabric Chair</a></h3>
                                            <div className="product__items--price style2">
                                ...
                                <div className="col d-xl-none d-xxl-block mb-25">
                                    <div className="product__items">
                                        <div className="product__items--thumbnail">
                                            <a className="product__items--link" href="product-details.html">
                                                <img className="product__items--img product__primary--img" src="../../src/assets/img/product/product15.webp" alt="product-img"/>
                                                <img className="product__items--img product__secondary--img" src="../../src/assets/img/product/product10.webp" alt="product-img"/>
                                            </a>
                                            <ul className="product__items--action d-flex justify-content-center">
                                                <li className="product__items--action__list">
